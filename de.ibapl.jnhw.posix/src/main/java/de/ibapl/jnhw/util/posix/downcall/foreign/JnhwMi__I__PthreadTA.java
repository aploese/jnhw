 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTA extends JnhwMi__I___A implements JnhwMh_sI__PthreadT {

    public JnhwMi__I__PthreadTA(SymbolLookup symbolLookup, String name) {
