 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTI__I extends JnhwMi__I___I__I implements JnhwMh_sI__PthreadT_sI.ExceptionErased {

    public JnhwMi__I__PthreadTI__I(MemorySegment methodAddress, String name) {
