 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTI__I extends JnhwMi__I___I__I implements JnhwMh_sI__PthreadT_sI {

    public JnhwMi__I__PthreadTI__I(SymbolLookup symbolLookup, String name) {
