 ...
 * @author aploese
 */
public class JniMi__I__PthreadTA__I__A extends JniMi__I___A__I__A implements JnhwMh_sI__PthreadT__sI__A.ExceptionErased {

    public JniMi__I__PthreadTA__I__A(MemorySegment methodAddress, String name) {
        super(methodAddress, name);
    }

    @Override
    public int invoke_sI__PthreadT__sI__A(Pthread.Pthread_t arg1, int arg2, MemorySegment arg3) {
        return invoke_sI___A_sI__A(arg1.toMemorySegment(), arg2, arg3);
    }
