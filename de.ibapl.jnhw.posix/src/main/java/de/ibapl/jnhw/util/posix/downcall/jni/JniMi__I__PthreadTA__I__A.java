 ...
 * @author aploese
 */
public class JniMi__I__PthreadTA__I__A extends JniMi__I___A__I__A implements JnhwMh_sI__PthreadT__sI__A {

    public JniMi__I__PthreadTA__I__A(SymbolLookup symbolLookup, String name) {
