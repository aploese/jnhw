 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTA__I extends JnhwMi__I___A__I implements JnhwMh_sI__PthreadT_sI.ExceptionErased {

    public JnhwMi__I__PthreadTA__I(MemorySegment methodAddress, String name) {
