 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTA__I extends JnhwMi__I___A__I implements JnhwMh_sI__PthreadT_sI {

    public JnhwMi__I__PthreadTA__I(SymbolLookup symbolLookup, String name) {
