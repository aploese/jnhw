 ...
 * @author aploese
 */
public class JniMi__I__PthreadTA__I extends JniMi__I___A__I implements JnhwMh_sI__PthreadT_sI {

    public JniMi__I__PthreadTA__I(SymbolLookup symbolLookup, String name) {
