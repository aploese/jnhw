 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTI extends JnhwMi__I___I implements JnhwMh_sI__PthreadT.ExceptionErased {

    public JnhwMi__I__PthreadTI(MemorySegment methodAddress, String name) {
        super(methodAddress, name);
    }

    @Override
    public int invoke_sI__PthreadT(Pthread.Pthread_t arg1) {
        return invoke_sI__uI(arg1.asUint32_t());
    }
