 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTI extends JnhwMi__I___I implements JnhwMh_sI__PthreadT {

    public JnhwMi__I__PthreadTI(SymbolLookup symbolLookup, String name) {
