 ...
 * @author aploese
 */
public class JniMi__I__PthreadTI__I extends JniMi__I___I__I implements JnhwMh_sI__PthreadT_sI.ExceptionErased {

    public JniMi__I__PthreadTI__I(MemorySegment methodAddress, String name) {
