 ...
 * @author aploese
 */
public class JnhwMi_clock_tI___V extends JnhwMi__I___V implements JnhwMh_clock_t___V.ExceptionErased {

    public JnhwMi_clock_tI___V(MemorySegment methodAddress, String name) {
        super(methodAddress, name);
    }

    @Override
    public long invoke_clock_t___V() {
        return invoke__I___V();
    }
