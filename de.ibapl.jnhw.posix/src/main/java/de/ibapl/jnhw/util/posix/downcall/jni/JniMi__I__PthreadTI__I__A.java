 ...
 * @author aploese
 */
public class JniMi__I__PthreadTI__I__A extends JniMi__I___I__I__A implements JnhwMh_sI__PthreadT__sI__A.ExceptionErased {

    public JniMi__I__PthreadTI__I__A(MemorySegment methodAddress, String name) {
