 ...
 * @author aploese
 */
public class JniMi_PthreadTI___V extends JniMi__I___V implements JnhwMh_PthreadT___V.ExceptionErased {

    public JniMi_PthreadTI___V(MemorySegment methodAddress, String name) {
