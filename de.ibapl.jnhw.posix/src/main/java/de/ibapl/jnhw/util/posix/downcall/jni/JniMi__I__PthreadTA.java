 ...
 * @author aploese
 */
public class JniMi__I__PthreadTA extends JniMi__I___A implements JnhwMh_sI__PthreadT.ExceptionErased {

    public JniMi__I__PthreadTA(MemorySegment methodAddress, String name) {
