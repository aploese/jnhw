 ...
 * @author aploese
 */
public class JniMi_clock_tL___V extends JniMi__L___V implements JnhwMh_clock_t___V.ExceptionErased {

    public JniMi_clock_tL___V(MemorySegment methodAddress, String name) {
