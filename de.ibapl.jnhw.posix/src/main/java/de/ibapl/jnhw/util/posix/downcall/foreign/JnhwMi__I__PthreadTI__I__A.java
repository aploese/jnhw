 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTI__I__A extends JnhwMi__I___I__I__A implements JnhwMh_sI__PthreadT__sI__A.ExceptionErased {

    public JnhwMi__I__PthreadTI__I__A(MemorySegment methodAddress, String name) {
        super(methodAddress, name);
    }

    @Override
    public int invoke_sI__PthreadT__sI__A(Pthread.Pthread_t arg1, int arg2, MemorySegment arg3) {
        return invoke_sI__uI_sI__A(arg1.asUint32_t(), arg2, arg3);
    }
