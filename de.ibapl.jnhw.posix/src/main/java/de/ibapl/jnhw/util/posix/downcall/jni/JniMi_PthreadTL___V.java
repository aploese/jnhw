 ...
 * @author aploese
 */
public class JniMi_PthreadTL___V extends JniMi__L___V implements JnhwMh_PthreadT___V.ExceptionErased {

    public JniMi_PthreadTL___V(MemorySegment methodAddress, String name) {
