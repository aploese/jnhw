 ...
 * @author aploese
 */
public class JnhwMi__I__PthreadTA__I__A extends JnhwMi__I___A__I__A implements JnhwMh_sI__PthreadT__sI__A {

    public JnhwMi__I__PthreadTA__I__A(SymbolLookup symbolLookup, String name) {
