 ...
 * @author aploese
 */
public class JnhwMi_PthreadTI___V extends JnhwMi__I___V implements JnhwMh_PthreadT___V {

    public JnhwMi_PthreadTI___V(SymbolLookup symbolLookup, String name) {
