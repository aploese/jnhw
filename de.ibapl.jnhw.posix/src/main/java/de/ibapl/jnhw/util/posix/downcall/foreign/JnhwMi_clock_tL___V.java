 ...
 * @author aploese
 */
public class JnhwMi_clock_tL___V extends JnhwMi__L___V implements JnhwMh_clock_t___V.ExceptionErased {

    public JnhwMi_clock_tL___V(MemorySegment methodAddress, String name) {
