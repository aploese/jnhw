...
//FreeBSD does not define _ISO_C_SOURCE 2011 if POSIX is set bug??? - so do not test datatypes on compile time... 
  ...
  //JNHW_ASSERT_DATA_TYPES(pthread_attr_t, uint64_t)
    ...
    #define _JNHW__nfds_t__IS__uint64_t 1
      ...
      #define _JNHW__clockid_t__IS__int32_t 1
      #define _JNHW__timer_t__IS__uint32_t 1
...
#if defined(_JNHW__timer_t__IS__uint64_t)
  #define JNHW_ASSERT__timer_t__IS__uint64_t__OR__int32_t__OR__uint32_t JNHW_ASSERT_DATA_TYPES(timer_t, uint64_t)
#elif defined(_JNHW__timer_t__IS__int32_t)
  #define JNHW_ASSERT__timer_t__IS__uint64_t__OR__int32_t__OR__uint32_t JNHW_ASSERT_DATA_TYPES(timer_t, int32_t)
#elif defined(_JNHW__timer_t__IS__uint32_t)
  #define JNHW_ASSERT__timer_t__IS__uint64_t__OR__int32_t__OR__uint32_t JNHW_ASSERT_DATA_TYPES(timer_t, uint32_t)
#else
  #error timer_t
#endif
