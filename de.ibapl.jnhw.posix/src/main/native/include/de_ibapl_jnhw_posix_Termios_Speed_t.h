...
#include <jni.h>
/* Header for class de_ibapl_jnhw_posix_Termios_Speed_t */

#ifndef _Included_de_ibapl_jnhw_posix_Termios_Speed_t
#define _Included_de_ibapl_jnhw_posix_Termios_Speed_t
#ifdef __cplusplus
extern "C" {
#endif
/*
