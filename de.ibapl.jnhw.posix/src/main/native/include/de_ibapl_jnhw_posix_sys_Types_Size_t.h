...
#include <jni.h>
/* Header for class de_ibapl_jnhw_posix_sys_Types_Size_t */

#ifndef _Included_de_ibapl_jnhw_posix_sys_Types_Size_t
#define _Included_de_ibapl_jnhw_posix_sys_Types_Size_t
#ifdef __cplusplus
extern "C" {
#endif
/*
