...
public class TimeTest {
    ...
    public static void checkBeforeAll_HAVE_TIME_H() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_HAVE_TIME_H");
    ...
    public static void checkBeforeAll_TimeDefines() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_TimeDefines");
    ...
    public static void checkBeforeAll_StructItimespec() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_StructItimespec");
    ...
    public static void checkBeforeAll_StructTimespec() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_StructTimespec");
        Assertions.assertAll(
    ...
    public static void checkBeforeAll_StructTm() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_StructTm");
        Assertions.assertAll(
    ...
    public static void checkBeforeAll_Timer_t() throws Exception {
        JnhwTestLogger.logBeforeAllBegin("checkBeforeAll_Timer_t");
        Assertions.assertAll(
    ...
    public void testClock_nanosleep() throws Exception {
        switch (MultiarchTupelBuilder.getOS()) {
            ...
            default -> {
                ...
                final long sleepTime = end - start;
                JnhwTestLogger.logTest("Thread.sleep(10) took %dms", sleepTime / 1_000_000);

                rqtp.tv_nsec(sleepTime);
                ...
                JnhwTestLogger.logTest("Time.clock_nanosleep(%dns) took %dms", testDuration, sleepTime / 1_000_000);
                //allow 30%
                final long sleepTimeMax = (sleepTime * 130) / 100;
                Assertions.assertTrue(testDuration < sleepTimeMax,
                        () -> String.format("expected max %dms but was %dms", (sleepTimeMax / 1_000_000), (testDuration / 1_000_000)));
                final long sleepTimeMin = sleepTime;
                //never to expect to be faster ...
                Assertions.assertTrue(testDuration >= sleepTimeMin,
                        () -> String.format("expected min %dms but was %dms", (sleepTimeMin / 1_000_000), (testDuration / 1_000_000)));
    ...
    public void testNanosleep() throws Exception {
        ...
        try {
            ...
            final long sleepTimeMax = (sleepTime * 130) / 100;
            Assertions.assertTrue(testDuration < sleepTimeMax,
                    String.format("expected max %dms but was %dmc", (sleepTimeMax / 1_000_000), (testDuration / 1_000_000)));
            final long sleepTimeMin = sleepTime;
            //never to expect to be faster ...
            Assertions.assertTrue(testDuration >= sleepTimeMin,
                    String.format("expected min %dms but was %dmc", (sleepTimeMin / 1_000_000), (testDuration / 1_000_000)));
    ...
    public void testTimer() throws Throwable {
        switch (MultiarchTupelBuilder.getOS()) {
            case APPLE -> {
                ...
                Assertions.assertTrue(LibcLoader.LIB_C_SYMBOL_LOOKUP.find("timer_create").isEmpty(), "timer_create is available");
                Assertions.assertTrue(LibcLoader.LIB_C_SYMBOL_LOOKUP.find("timer_gettime").isEmpty(), "timer_gettime is available");
                Assertions.assertTrue(LibcLoader.LIB_C_SYMBOL_LOOKUP.find("timer_settime").isEmpty(), "timer_settime is available");
                Assertions.assertTrue(LibcLoader.LIB_C_SYMBOL_LOOKUP.find("timer_getoverrun").isEmpty(), "timer_getoverrun is available");
                Assertions.assertTrue(LibcLoader.LIB_C_SYMBOL_LOOKUP.find("timer_delete").isEmpty(), "timer_delete is available");
            ...
            case OPEN_BSD -> {
                // preconditions not met can only test this this way.
                Assertions.assertTrue(LibrtLoader.LIB_RT_SYMBOL_LOOKUP.find("timer_create").isEmpty(), "timer_create is available");
                Assertions.assertTrue(LibrtLoader.LIB_RT_SYMBOL_LOOKUP.find("timer_gettime").isEmpty(), "timer_gettime is available");
                Assertions.assertTrue(LibrtLoader.LIB_RT_SYMBOL_LOOKUP.find("timer_settime").isEmpty(), "timer_settime is available");
                Assertions.assertTrue(LibrtLoader.LIB_RT_SYMBOL_LOOKUP.find("timer_getoverrun").isEmpty(), "timer_getoverrun is available");
                Assertions.assertTrue(LibrtLoader.LIB_RT_SYMBOL_LOOKUP.find("timer_delete").isEmpty(), "timer_delete is available");
