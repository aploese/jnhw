...
public class LocaleTest {
    ...
    public void testSizeof__locale_t() throws Exception {
        Assertions.assertTrue(LibJnhwPosixTestLoader.invoke_sI___V("sizeof__locale_t") >= Defines.__SIZEOF_POINTER__, "sizeof locale_t " + LibJnhwPosixTestLoader.invoke_sI___V("sizeof__locale_t") + " must be >= sizeof uintptr_t " + Defines.__SIZEOF_POINTER__);
    }
    ...
    public void testNewlocale_null() throws Exception {
        ...
        JnhwTestLogger.logTest("newlocale base == null");
        Assertions.assertThrows(NullPointerException.class, () -> {
