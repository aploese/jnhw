...
public class JnhwTestLogger {
    ...
    public static void logAfterEach(TestInfo testInfo) {
        if (PRINT_LOG) {
            System.out.println("Test done: " + testInfo.getDisplayName());
            flushAndWait();
        }
    }

    public static void logBeforeAllBeginn(String text) {
        if (PRINT_LOG) {
            System.out.println(text);
            flushAndWait();
        }
    ...
    public static void logAftereAllBeginn(String text) {
        if (PRINT_LOG) {
            System.out.println(text);
            flushAndWait();
        }
    ...
    public static void logAftereAllEnd(String text) {
        if (PRINT_LOG) {
            System.out.println(text);
            flushAndWait();
        }
