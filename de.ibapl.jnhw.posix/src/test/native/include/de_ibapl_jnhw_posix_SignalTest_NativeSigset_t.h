...
#include <jni.h>
/* Header for class de_ibapl_jnhw_posix_SignalTest_NativeSigset_t */

#ifndef _Included_de_ibapl_jnhw_posix_SignalTest_NativeSigset_t
#define _Included_de_ibapl_jnhw_posix_SignalTest_NativeSigset_t
#ifdef __cplusplus
extern "C" {
#endif
/*
