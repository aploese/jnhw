...
#include <jni.h>
/* Header for class de_ibapl_jnhw_posix_TimeTest_NativeTimer_t */

#ifndef _Included_de_ibapl_jnhw_posix_TimeTest_NativeTimer_t
#define _Included_de_ibapl_jnhw_posix_TimeTest_NativeTimer_t
#ifdef __cplusplus
extern "C" {
#endif
/*
