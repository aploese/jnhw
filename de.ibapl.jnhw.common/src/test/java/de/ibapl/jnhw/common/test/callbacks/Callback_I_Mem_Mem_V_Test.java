...
public class Callback_I_Mem_Mem_V_Test {
    ...
    private static void doCallTheCallback(int value, A a, B b) {
        doCallTheCallback(value, AbstractNativeMemory.toUintptr_t(a), AbstractNativeMemory.toUintptr_t(b));
    }
    ...
    public void testNativeFunctionPointer() {
        ...
        final Callback_I_Mem_Mem_V<A, B> testPtr = new Callback_I_Mem_Mem_V(NativeAddressHolder.ofUintptr_t(121)) {
            @Override
    ...
    public void testReleaseByGarbageCollector() {
        ...
        assertEquals(b, refB[0]);
        assertNotSame(a, refA[0]);
        assertNotSame(b, refB[0]);
