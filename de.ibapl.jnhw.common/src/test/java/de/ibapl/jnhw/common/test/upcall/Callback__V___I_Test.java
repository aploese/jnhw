...
public class Callback__V___I_Test {
    ...
    static {
        ...
        getCallback__V___I = JnhwMh_MA___V.mandatoryOf(LibJnhwCommonTestLoader.SYMBOL_LOOKUP, "getCallback__V___I", BaseDataType.uintptr_t, 0);
    ...
    public void testNativeFunctionPointer() {
        final Callback__V___I testPtr = new Callback__V___I((t) -> MemorySegment.ofAddress(121)) {
            @Override
    ...
    public void testCallAndRelease(final int testValue) {
        ...
        final Callback__V___I NULL_PTR = new Callback__V___I((t) -> MemorySegment.NULL) {
            @Override
            protected void callback(int value) {
                throw new UnsupportedOperationException("Not supported yet.");
            }
        ...
        try {
            ...
            ref[0] = 0;
            JnhwMh__V__sI.of(
                    getCallback__V___I().toMemorySegment(),
                    "testCallback",
