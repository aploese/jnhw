...
public class Callback__V___I__I_MA_Test {
    ...
    static {
        ...
        getCallback__V___I__I_MA = JnhwMh_MA___V.mandatoryOf(LibJnhwCommonTestLoader.SYMBOL_LOOKUP, "getCallback__V___I__I_MA", BaseDataType.uintptr_t, 0);
    ...
    private static FunctionPtr__V___I__I_MA getCallback__V___I__I_MA() {
        try {
            return FunctionPtr__V___I__I_MA.wrap(getCallback__V___I__I_MA.invoke_MA___V());
        } catch (Throwable t) {
    ...
    public void testNativeFunctionPointer() {
        ...
        final Callback__V___I__I_MA testPtr = new Callback__V___I__I_MA((t) -> MemorySegment.ofAddress(121)) {
            @Override
            protected void callback(int a, int b, MemorySegment c) {
    ...
    public void testCallAndRelease(final int testValueInt) {
        ...
        try {
            ...
            JnhwMh__V__sI_sI__A.of(
                    getCallback__V___I__I_MA().toMemorySegment(),
                    "testCallback",
