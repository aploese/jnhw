...
public class OpaqueMemory64Test {
    ...
    public void testAllocateDirtyMem() throws Exception {
        OpaqueMemory64 mem = new OpaqueMemory64(1024, false);
    ...
    public void testAllocateCleanMem() throws Exception {
        OpaqueMemory64 mem = new OpaqueMemory64(1024, true);
        Assertions.assertEquals(1024, mem.sizeInBytes);
        Assertions.assertEquals(mem, mem.memoryOwner);
        mem = null;
        System.gc();
    ...
    public void testCAllocateDirtyMem() throws Exception {
        OpaqueMemory64 mem = new OpaqueMemory64(2, 512, false);
        Assertions.assertEquals(1024, mem.sizeInBytes);
        Assertions.assertEquals(mem, mem.memoryOwner);
        mem = null;
        System.gc();
    ...
    public void testCAllocateCleanMem() throws Exception {
        OpaqueMemory64 mem = new OpaqueMemory64(2, 512, true);
        Assertions.assertEquals(1024, mem.sizeInBytes);
        Assertions.assertEquals(mem, mem.memoryOwner);
        mem = null;
        System.gc();
    ...
    public void testCopyIndex() throws Exception {
        ...
        final OpaqueMemory64 mem = new OpaqueMemory64(array.length, false);
    ...
    public void testSetGetIndex() throws Exception {
        final OpaqueMemory64 mem = new OpaqueMemory64(16, false);
        Assertions.assertAll(() -> {
            //Exact fit
    ...
    private class TestMem extends OpaqueMemory64 {
    ...
    public void testEquals() throws Exception {
        OpaqueMemory64 mem = new TestMem(new NativeAddressHolder(0x2aL), 8);
        OpaqueMemory64 mem1 = new OpaqueMemory64(new NativeAddressHolder(42L), 8);
        OpaqueMemory64 mem2 = new OpaqueMemory64(mem, 0, 8);
