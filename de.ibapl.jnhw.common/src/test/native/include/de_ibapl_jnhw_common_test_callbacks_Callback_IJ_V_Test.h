...
#include <jni.h>
/* Header for class de_ibapl_jnhw_common_test_callbacks_Callback_IJ_V_Test */

#ifndef _Included_de_ibapl_jnhw_common_test_callbacks_Callback_IJ_V_Test
#define _Included_de_ibapl_jnhw_common_test_callbacks_Callback_IJ_V_Test
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     de_ibapl_jnhw_common_test_callbacks_Callback_IJ_V_Test
 ...
 * Class:     de_ibapl_jnhw_common_test_callbacks_Callback_IJ_V_Test
 * Method:    setCallback
 * Signature: (Lde/ibapl/jnhw/common/callback/Callback_IJ_V;)V
 */
