...
#include <jni.h>
/* Header for class de_ibapl_jnhw_common_test_callbacks_Callback_Mem_V_Test */

#ifndef _Included_de_ibapl_jnhw_common_test_callbacks_Callback_Mem_V_Test
#define _Included_de_ibapl_jnhw_common_test_callbacks_Callback_Mem_V_Test
#ifdef __cplusplus
extern "C" {
#endif
/*
