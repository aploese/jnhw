...
public interface JnhwMh__A__sI__A__A extends JnhwMethodHandle {
                    ...
                    case int32_t:
                        switch (arg2) {
                            case intptr_t:
                                switch (arg3) {
                                    case intptr_t:
                                        return new JnhwMi_MA___I__A__A(symbolLookup, name);
                                    default:
    ...
    MemoryAddress invoke_MA__sI_P_P(int arg1, Pointer<?> arg2, Pointer<?> arg3);

    MemoryAddress invoke_MA__sI_A_P(int arg1, Addressable arg2, Pointer<?> arg3);
