 ...
 * @author aploese
 */
public class JniCallbackFactory__V__Union_I_MA extends CallbackFactory__V__Union_I_MA {
    ...
    private MemorySegment registerCallBack(int index) {
        final long result = registerCallBack(index, JniCallbackFactory__V__Union_I_MA.class, "trampoline_" + index);
        if (result == 0) {
