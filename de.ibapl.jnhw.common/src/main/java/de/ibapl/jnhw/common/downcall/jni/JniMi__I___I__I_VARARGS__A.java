 ...
 * @author aploese
 */
public class JniMi__I___I__I_VARARGS__A extends JniMethodInvoker implements JnhwMh_sI__sI_uL_VARARGS__A.ExceptionErased {

    protected final static native int invoke__I___I__I__A(long address, int arg1, int arg2, long arg3);

    public JniMi__I___I__I_VARARGS__A(MemorySegment methodAddress, String name) {
