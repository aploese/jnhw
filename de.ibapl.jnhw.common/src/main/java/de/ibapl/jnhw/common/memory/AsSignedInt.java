...
public class AsSignedInt extends NativeIntNumber {
    ...
    public AsSignedInt(BaseDataType nativeType, AbstractNativeMemory owner, long offset, SetMem setMem) {
    ...
    public void nativeToString(Appendable sb, String indentPrefix, String indent) throws IOException {
        sb.append(MEM_ACCESS.getSignedIntOf_nativeToString(this, 0, sizeInBytes));
    }
