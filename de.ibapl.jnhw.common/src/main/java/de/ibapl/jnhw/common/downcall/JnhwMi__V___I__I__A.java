...
import de.ibapl.jnhw.common.downcall.wrapper.JnhwMh__V__sI_sI__A;
...
public class JnhwMi__V___I__I__A extends JnhwMethodInvoker implements JnhwMh__V__sI_sI__A {
    ...
    public JnhwMi__V___I__I__A(MemoryAddress address, ResourceScope scope) {
        super(address, FD, scope);
    }

    @Override
    public void invoke__V__sI_sI__P(int arg1, int arg2, Pointer<?> arg3) {
        try {
            methodHandle.invokeExact(arg1, arg2, arg3.toAddressable());
