...
import de.ibapl.jnhw.common.downcall.JnhwMi__I___I__A__A;
...
public interface JnhwMh_sI__sI__A__A extends JnhwMethodHandle {
    ...
    public static JnhwMh_sI__sI__A__A of(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
    ...
    public static JnhwMh_sI__sI__A__A ofOrNull(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
        return of(C_LINKER, name, result, arg1, arg2, arg3);
    }
                    ...
                    case int32_t:
                        switch (arg2) {
                            case intptr_t:
                                switch (arg3) {
                                    case intptr_t:
                                        return new JnhwMi__I___I__A__A(symbolLookup, name);
                                    default:
    ...
    int invoke_sI__sI__P__P(int arg1, Pointer<?> arg2, Pointer<?> arg3);
