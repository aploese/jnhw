 ...
 * @author aploese
 */
public class JniMi__L___A extends JniMethodInvoker implements JnhwMh_sL___A.ExceptionErased, JnhwMh_uL___A.ExceptionErased {

    protected final static native long invoke__L___A(long address, long arg1);

    public JniMi__L___A(MemorySegment methodAddress, String name) {
