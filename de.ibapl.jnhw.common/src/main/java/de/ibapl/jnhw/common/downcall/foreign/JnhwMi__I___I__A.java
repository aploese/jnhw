 ...
 * @author aploese
 */
public class JnhwMi__I___I__A extends JnhwMethodInvoker implements JnhwMh_sI__sI__A.ExceptionErased {

    public JnhwMi__I___I__A(MemorySegment methodAddress, String name) {
