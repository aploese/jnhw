...
public class IntPtr_t<T extends OpaqueMemory> extends OpaqueMemory<T> {
    ...
    public static IntPtr_t allocateNative(ResourceScope scope) {
        return new IntPtr_t(MemorySegment.allocateNative(DATA_TYPE.SIZE_OF, scope), 0);
    }
    ...
    public T get(OpaqueMemoryProducer<T, IntPtr_t> opaqueMemoryProducer, ResourceScope rs) {
