 ...
 * @author aploese
 */
public class JnhwMi__I___A__A__A extends JnhwMethodInvoker implements JnhwMh_sI___A__A__A, JnhwMh__B___A__A__A {

    public JnhwMi__I___A__A__A(SymbolLookup symbolLookup, String name) {
    ...
    @Override
    public int invoke_sI___P__P__P(Pointer<?> arg1, Pointer<?> arg2, Pointer<?> arg3) {
        try {
    ...
    @Override
    public boolean invoke__B___P__P__P(Pointer<?> arg1, Pointer<?> arg2, Pointer<?> arg3) {
        try {
