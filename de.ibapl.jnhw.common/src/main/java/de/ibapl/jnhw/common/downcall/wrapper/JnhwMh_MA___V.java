...
import de.ibapl.jnhw.common.downcall.JnhwMi_MA___V;
...
public interface JnhwMh_MA___V extends JnhwMethodHandle {
    ...
    public static JnhwMh_MA___V ofOrNull(String name, BaseDataType result) {
    ...
    public static JnhwMh_MA___V of(String name, BaseDataType result) {
    ...
    public static JnhwMh_MA___V of(SymbolLookup symbolLookup, String name, BaseDataType result) {
        switch (result) {
            case intptr_t -> {
                return new JnhwMi_MA___V(symbolLookup, name);
            }
            default ->
