 ...
 * @author aploese
 */
public class JniMi__I___A__I__I extends JniMethodInvoker implements JnhwMh_sI___A_sI_uI, JnhwMh_uI___A_uI_BL, JnhwMh_sI___A_uL_sI {

    protected final static native int invoke__I___A__I__I(long address, long arg1, int arg2, int arg3);

    public JniMi__I___A__I__I(SymbolLookup symbolLookup, String name) {
