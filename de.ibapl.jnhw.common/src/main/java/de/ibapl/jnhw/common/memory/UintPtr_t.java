 ...
 * @author aploese
 */
public class UintPtr_t<T extends OpaqueMemory> extends OpaqueMemory<T> {
    ...
    public void set(T value) {
        if (value == null) {
            MEM_ACCESS.uintptr_t(memorySegment, 0, MemoryAddress.NULL);
        } else {
            MEM_ACCESS.uintptr_t(memorySegment, 0, OpaqueMemory.getMemorySegment(value));
        }
        cached = value;
    }
