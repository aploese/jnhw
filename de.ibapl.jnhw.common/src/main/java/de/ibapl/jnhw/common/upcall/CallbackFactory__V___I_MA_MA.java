...
public abstract class CallbackFactory__V___I_MA_MA {
    ...
    private final static Logger LOG = Logger.getLogger("d.i.j.c.CallbackFactory__V___I_MA_MA");

    private final static CLinker C_LINKER = CLinker.systemCLinker();

    public static final int MAX_CALL_BACKS = 16;

    private static final WeakReference<Callback__V___I_MA_MA> REFS[] = new WeakReference[MAX_CALL_BACKS];
    ...
    static Callback__V___I_MA_MA find(NativeFunctionPointer callbackPtr) {
        for (WeakReference<Callback__V___I_MA_MA> wr : REFS) {
            Callback__V___I_MA_MA cb = wr.get();
            if (cb != null) {
    ...
    static NativeSymbol registerCallBack(int index) throws NoSuchMethodException, IllegalAccessException {
        MethodHandle handle = MethodHandles.lookup().findStatic(CallbackFactory__V___I_MA_MA.class, "trampoline_" + index, MethodType.methodType(void.class, int.class, MemoryAddress.class, MemoryAddress.class));
        return C_LINKER.upcallStub(handle, FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS), ResourceScope.globalScope());
    }
    ...
    public static int callbacksAvailable() {
        int result = 0;
        for (WeakReference<Callback__V___I_MA_MA> ref : REFS) {
            if (ref.get() == null) {
                result++;
            }
        }
    ...
    private static void trampoline_0(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[0].get();
            if (ref == null) {
    ...
    private static void trampoline_1(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[1].get();
            if (ref == null) {
    ...
    private static void trampoline_2(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[2].get();
            if (ref == null) {
    ...
    private static void trampoline_3(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[3].get();
            if (ref == null) {
    ...
    private static void trampoline_4(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[4].get();
            if (ref == null) {
    ...
    private static void trampoline_5(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[5].get();
            if (ref == null) {
    ...
    private static void trampoline_6(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[6].get();
            if (ref == null) {
    ...
    private static void trampoline_7(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[7].get();
            if (ref == null) {
    ...
    private static void trampoline_8(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[8].get();
            if (ref == null) {
    ...
    private static void trampoline_9(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[9].get();
            if (ref == null) {
    ...
    private static void trampoline_10(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[10].get();
            if (ref == null) {
    ...
    private static void trampoline_11(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[11].get();
            if (ref == null) {
    ...
    private static void trampoline_12(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[12].get();
            if (ref == null) {
    ...
    private static void trampoline_13(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[13].get();
            if (ref == null) {
    ...
    private static void trampoline_14(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[14].get();
            if (ref == null) {
    ...
    private static void trampoline_15(final int a, final MemoryAddress b, final MemoryAddress c) {
        try {
            final Callback__V___I_MA_MA ref = REFS[15].get();
            if (ref == null) {
