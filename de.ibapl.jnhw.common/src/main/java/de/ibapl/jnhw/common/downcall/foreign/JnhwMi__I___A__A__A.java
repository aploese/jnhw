 ...
 * @author aploese
 */
public class JnhwMi__I___A__A__A extends JnhwMethodInvoker implements JnhwMh_sI___A__A__A.ExceptionErased, JnhwMh_BL___A__A__A.ExceptionErased {

    public JnhwMi__I___A__A__A(MemorySegment methodAddress, String name) {
        super(methodAddress, name, FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    }
