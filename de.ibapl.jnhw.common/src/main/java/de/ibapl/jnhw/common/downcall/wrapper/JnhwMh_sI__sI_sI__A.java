...
import de.ibapl.jnhw.common.downcall.JnhwMi__I___I__I__A;
...
public interface JnhwMh_sI__sI_sI__A extends JnhwMethodHandle {
    ...
    public static JnhwMh_sI__sI_sI__A ofOrNull(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
    ...
    public static JnhwMh_sI__sI_sI__A of(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
                    ...
                    case int32_t:
                        switch (arg2) {
                            case int32_t:
                                switch (arg3) {
                                    case intptr_t:
                                        return new JnhwMi__I___I__I__A(symbolLookup, name);
                                    default:
    ...
    int invoke_sI__sI_sI_P(int arg1, int arg2, Pointer<?> arg3);

    int invoke_sI__sI_sI_A(int arg1, int arg2, Addressable arg3);
