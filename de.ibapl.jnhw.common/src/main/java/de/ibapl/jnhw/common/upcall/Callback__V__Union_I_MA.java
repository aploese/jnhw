 ...
 * @author aploese
 */
public abstract class Callback__V__Union_I_MA<A extends OpaqueMemory> extends FunctionPtr__V__Union_I_MA<A> {
     ...
     */
    public static Callback__V__Union_I_MA<?> find(FunctionPtr__V__Union_I_MA callbackPtr) {
    ...
    public Callback__V__Union_I_MA() {
        super(CallbackFactory__V__Union_I_MA::aquire);
        REFS.add(new WeakReference<>(this));
    }
