 ...
 * @author aploese
 */
public class JniMi__I___I__B__I__I extends JniMethodInvoker implements JnhwMh_sI__sI_sB_sI_sI {

    protected final static native int invoke__I___I__B__I__I(long address, int arg1, byte arg2, int arg3, int arg4);

    public JniMi__I___I__B__I__I(SymbolLookup symbolLookup, String name) {
