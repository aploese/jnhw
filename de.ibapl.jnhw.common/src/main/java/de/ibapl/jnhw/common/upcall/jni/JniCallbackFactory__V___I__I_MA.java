 ...
 * @author aploese
 */
public class JniCallbackFactory__V___I__I_MA extends CallbackFactory__V___I__I_MA {
    ...
    private MemorySegment registerCallBack(int index) {
        final long result = registerCallBack(index, JniCallbackFactory__V___I__I_MA.class, "trampoline_" + index);
        if (result == 0) {
