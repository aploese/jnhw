 ...
 * @author aploese
 */
public class JniMi__I___I__L__L__I extends JniMethodInvoker implements JnhwMh_sI__sI_sL_sL_sI.ExceptionErased {

    protected final static native int invoke__I___I__L__L__I(long address, int arg1, long arg2, long arg3, int arg4);

    public JniMi__I___I__L__L__I(MemorySegment methodAddress, String name) {
