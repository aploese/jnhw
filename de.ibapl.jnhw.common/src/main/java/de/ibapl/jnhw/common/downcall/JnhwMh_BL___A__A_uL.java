...
public interface JnhwMh_BL___A__A_uL extends JnhwMethodHandle {
    ...
    public static JnhwMh_BL___A__A_uL ofOrNull(SymbolLookup symbolLookup, String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
        try {
    ...
    public static JnhwMh_BL___A__A_uL of(SymbolLookup symbolLookup, String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2, BaseDataType arg3) {
                            ...
                            case intptr_t, uintptr_t ->
                                switch (arg3) {
                                    case uint32_t ->
                                        ...
                                        () -> new JnhwMi__I___A__A__I(symbolLookup, name),
                                        () -> new JniMi__I___A__A__I(symbolLookup, name));
                                    case uint64_t ->
                                        NativeProvider.getProvider(
                                        () -> new JnhwMi__I___A__A__L(symbolLookup, name),
                                        () -> new JniMi__I___A__A__L(symbolLookup, name));
                                    default ->
