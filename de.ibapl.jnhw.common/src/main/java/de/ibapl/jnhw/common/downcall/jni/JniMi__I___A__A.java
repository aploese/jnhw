 ...
 * @author aploese
 */
public class JniMi__I___A__A extends JniMethodInvoker implements JnhwMh_sI___A__A, JnhwMh_BL___A__A {

    protected final static native int invoke__I___A__A(long address, long arg1, long arg2);

    public JniMi__I___A__A(SymbolLookup symbolLookup, String name) {
