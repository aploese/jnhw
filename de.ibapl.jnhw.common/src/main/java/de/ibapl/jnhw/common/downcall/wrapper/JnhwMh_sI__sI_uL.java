...
import de.ibapl.jnhw.common.downcall.JnhwMi__I___I__L;
...
public interface JnhwMh_sI__sI_uL extends JnhwMethodHandle {
    ...
    public static JnhwMh_sI__sI_uL ofOrNull(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2) {
    ...
    public static JnhwMh_sI__sI_uL of(String name, BaseDataType result, BaseDataType arg1, BaseDataType arg2) {
            ...
            case int32_t:
                switch (arg1) {
                    case int32_t:
                        switch (arg2) {
                            case uint64_t:
                                return new JnhwMi__I___I__L(symbolLookup, name);
                            case uint32_t:
