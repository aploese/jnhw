 ...
 */
@FunctionalInterface
public interface JnhwMh_BL___A extends JnhwMethodHandle {

    @FunctionalInterface
    interface ExceptionErased extends JnhwMh_BL___A {
    ...
    static JnhwMh_BL___A optionalOf(SymbolLookup symbolLookup, String name, BaseDataType result, BaseDataType arg1) {
    ...
    public static JnhwMh_BL___A.ExceptionErased of(MemorySegment methodAddress, String name, BaseDataType result, BaseDataType arg1) {
