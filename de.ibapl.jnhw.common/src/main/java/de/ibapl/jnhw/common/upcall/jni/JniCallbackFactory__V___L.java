 ...
 * @author aploese
 */
public class JniCallbackFactory__V___L extends CallbackFactory__V___L {
    ...
    private MemorySegment registerCallBack(int index) {
        final long result = registerCallBack(index, CallbackFactory__V___L.class, "trampoline_" + index);
        if (result == 0) {
    ...
    @Override
    protected MemoryAddress aquire0(Callback__V___L cb) {
