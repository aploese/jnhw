...
import de.ibapl.jnhw.common.downcall.foreign.JnhwMi__I___I__L__A;
import de.ibapl.jnhw.common.downcall.jni.JniMi__I___I__I__A;
import de.ibapl.jnhw.common.downcall.jni.JniMi__I___I__L__A;
                        ...
                        switch (arg2) {
                            ...
                            case uint64_t ->
                                switch (arg3) {
                                    case intptr_t, uintptr_t ->
                                        NativeProvider.getProvider(
                                        () -> new JnhwMi__I___I__L__A(symbolLookup, name),
                                        () -> new JniMi__I___I__L__A(symbolLookup, name));
                                    default ->
                                        throw new IllegalArgumentException("arg3 unexpected data type: " + name + " " + arg3);
                                };
                            default ->
