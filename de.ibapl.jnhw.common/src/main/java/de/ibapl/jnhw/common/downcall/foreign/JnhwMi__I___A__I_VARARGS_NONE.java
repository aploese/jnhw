 ...
 * @author aploese
 */
public class JnhwMi__I___A__I_VARARGS_NONE extends JnhwMethodInvoker implements JnhwMh_sI___A_sI_VARARGS_NONE.ExceptionErased {

    public JnhwMi__I___A__I_VARARGS_NONE(MemorySegment methodAddress, String name) {
