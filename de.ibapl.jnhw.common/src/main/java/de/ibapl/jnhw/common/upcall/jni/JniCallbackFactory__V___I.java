 ...
 * @author aploese
 */
public class JniCallbackFactory__V___I extends CallbackFactory__V___I {
    ...
    private MemorySegment registerCallBack(int index) {
        final long result = registerCallBack(index, CallbackFactory__V___I.class, "trampoline_" + index);
        if (result == 0) {
    ...
    @Override
    protected MemorySegment aquire0(Callback__V___I cb) {
