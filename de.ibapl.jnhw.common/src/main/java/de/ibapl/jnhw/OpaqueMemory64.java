 ...
 * @author aploese
 */
public class OpaqueMemory64 extends AbstractNativeMemory {
     ...
     * @param clearMem
     */
    public OpaqueMemory64(long sizeInBytes, boolean clearMem) throws NoSuchNativeMethodException {
     ...
     * @param clearMem
     */
    public OpaqueMemory64(long elements, long elementSizeInBytes, boolean clearMem) throws NoSuchNativeMethodException  {
    ...
    public static void nativeToString(OpaqueMemory64 mem, StringBuilder sb) {
