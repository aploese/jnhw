...
#include "de_ibapl_jnhw_common_callback_Callback_I_V_Impl.h"
...
#define MAX_CALL_BACKS 8
    ...
    /*
     * Class:     de_ibapl_jnhw_common_callback_Callback_I_V_Impl
     * Method:    initNative
     * Signature: ()V
     */
    JNIEXPORT void JNICALL Java_de_ibapl_jnhw_common_callback_Callback_1I_1V_1Impl_initNative
...
#define TRAMPOLINE(index) \
     ...
     */
    JNIEXPORT jobject JNICALL Java_de_ibapl_jnhw_common_callback_Callback_1I_1V_1Impl_getNativeAddress
    (JNIEnv *env, __attribute__ ((unused))jclass clazz, jint index) {
        switch (index) {
#define TRAMPOLINE_CASE(index) case index: return CREATE_NativeAddressHolder(&_jnhw_trampoline_I_V__ ## index);
                TRAMPOLINE_CASE(0);
                TRAMPOLINE_CASE(1);
                TRAMPOLINE_CASE(2);
                TRAMPOLINE_CASE(3);
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_de_ibapl_jnhw_common_callback_Callback_1I_1V_1Impl_MAX_1CALL_1BACKS
