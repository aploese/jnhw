...
#include <jni.h>
/* Header for class de_ibapl_jnhw_common_memory_AbstractNativeMemory_NativeMemoryAlignment */

#ifndef _Included_de_ibapl_jnhw_common_memory_AbstractNativeMemory_NativeMemoryAlignment
#define _Included_de_ibapl_jnhw_common_memory_AbstractNativeMemory_NativeMemoryAlignment
#ifdef __cplusplus
extern "C" {
#endif
/*
