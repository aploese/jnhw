...
#include <jni.h>
/* Header for class de_ibapl_jnhw_common_memory_Uint64_t */

#ifndef _Included_de_ibapl_jnhw_common_memory_Uint64_t
#define _Included_de_ibapl_jnhw_common_memory_Uint64_t
#ifdef __cplusplus
extern "C" {
#endif
/*
