...
#include <jni.h>
/* Header for class de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___I__I_MA */

#ifndef _Included_de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___I__I_MA
#define _Included_de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___I__I_MA
#ifdef __cplusplus
extern "C" {
#endif
#undef de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___I__I_MA_MAX_CALL_BACKS
#define de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___I__I_MA_MAX_CALL_BACKS 16L
/*
