...
#if defined(__LP64__)
 #define MSG_UNASSIGNED "From C code: unassigned Callback__V___I__I_MA %d @0x%016lx no upcall handle!\n"
 #define MSG_ATTACH_THREAD_FAILED "From C code: Callback__V___I__I_MA %d @0x%016lx can't attach to thread!\n"
 #define MSG_NO_UPCALL "From C code: Callback__V___I__I_MA %d @0x%016lx can't get env!\n"
#elif defined(__WIN64__)
 #define MSG_UNASSIGNED "From C code: unassigned Callback__V___I__I_MA %d @0x%016Lx no upcall handle!\n"
 #define MSG_ATTACH_THREAD_FAILED "From C code: Callback__V___I__I_MA %d @0x%016Lx can't attach to thread!\n"
 #define MSG_NO_UPCALL "From C code: Callback__V___I__I_MA %d @0x%016Lx can't get env!\n"
#else 
 #define MSG_UNASSIGNED "From C code: unassigned Callback__V___I__I_MA %d @0x%08x no upcall handle!\n"
 #define MSG_ATTACH_THREAD_FAILED "From C code: Callback__V___I__I_MA %d @0x%08x can't attach to thread!\n"
 #define MSG_NO_UPCALL "From C code: Callback__V___I__I_MA %d @0x%08x can't get env!\n"
#endif 
