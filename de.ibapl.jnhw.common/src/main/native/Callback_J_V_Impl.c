...
#include "de_ibapl_jnhw_Callback_J_V_Impl.h"
...
#define MAX_CALL_BACKS 8
    ...
    /*
     * Class:     de_ibapl_jnhw_Callback_J_V_Impl
     * Method:    initNative
     * Signature: ()V
     */
    JNIEXPORT void JNICALL Java_de_ibapl_jnhw_Callback_1J_1V_1Impl_initNative
...
#define TRAMPOLINE(index) \
    void _jnhw_trampoline_J_V__ ## index (int64_t value) {\
    JNIEnv *env;\
 ...
 */
JNIEXPORT jobject JNICALL Java_de_ibapl_jnhw_Callback_1J_1V_1Impl_getNativeAddress
...
#define TRAMPOLINE_CASE(index) case index: return CREATE_NATIVE_ADDRESS_HOLDER(&_jnhw_trampoline_J_V__ ## index);
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_de_ibapl_jnhw_Callback_1J_1V_1Impl_MAX_1CALL_1BACKS
