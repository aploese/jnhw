...
#include "de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___L.h"
...
#define TRAMPOLINE(index) \
    ...
    void _jnhw_trampoline__V___L__ ## index (int64_t value) {\
        ...
        if ((callback_refs.callbackClassRef == NULL) || (callback_refs.trampolineMethodID == 0)) { \
            jnhw_log_stderr(MSG_UNASSIGNED, index, (uintptr_t)&_jnhw_trampoline__V___L__ ## index); \
            return; \
        } \
        JNIEnv *env;\
        if ((*common_jvm)->AttachCurrentThread(common_jvm, (void**) &env, NULL)) {\
            jnhw_log_stderr(MSG_ATTACH_THREAD_FAILED, index, (uintptr_t)&_jnhw_trampoline__V___L__ ## index); \
return;\
        } else {\
            if (*env == NULL) {\
            jnhw_log_stderr(MSG_NO_UPCALL, index, (uintptr_t)&_jnhw_trampoline__V___L__ ## index); \
                return;\
            }\
...
TRAMPOLINE(15)
    ...
    /*
     * Class:     de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory__V___L
     * Method:    registerCallBack
     * Signature: (ILjava/lang/Class;Ljava/lang/String;)J
     */
    JNIEXPORT jlong JNICALL Java_de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory_1_1V_1_1_1L_registerCallBack
...
#define TRAMPOLINE_REGISTER_CASE(index) case index: \
                ...
                return (int64_t)(uintptr_t)&_jnhw_trampoline__V___L__ ## index;
     ...
     * Signature: (I)I
     */
    JNIEXPORT jint JNICALL Java_de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory_1_1V_1_1_1L_releaseCallBack
...
#define TRAMPOLINE_RELEASE_CASE(index) case index: \
     ...
     * Signature: ()I
     */
    JNIEXPORT jint JNICALL Java_de_ibapl_jnhw_common_upcall_jni_JniCallbackFactory_1_1V_1_1_1L_getMaxCallBacks
